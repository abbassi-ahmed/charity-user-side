...
const projects = [
  {
    ...
    image: image1,
    category: "Design",
    date: "20 jours restants",
    title: "Une nouvelle super voiture sur votre poignet",
    goal: "3600.00",
    raised: 23,
  },
  {
...
export const projectsArea = {
  tagline: "Entreprises que vous pouvez soutenir",
  ...
  projects: [
    {
      ...
      tagline: "Design",
      date: "20 jours restants",
      title: "La batterie externe toujours chargée",
      raised: 23,
    },
    {
      id: 2,
...
export const projectArea = [
  {
    ...
    bg: bg1,
    title: "Prêt ? Explorez",
    text: "Découvrez de nombreux projets passionnants qui n'attendent que votre soutien.",
    linkText: "Découvrir les projets",
  },
  {
    id: 2,
    bg: bg2,
    title: "Vous vous sentez inspiré ?",
    text: "Rejoignez notre communauté et contribuez à des projets qui font la différence.",
    linkText: "Rejoignez notre équipe",
