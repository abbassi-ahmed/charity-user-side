...
const ProjectsArea = ({ className =""  })=>{
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        const fetchProjects = async ()=>{
            try {
                const response1 = await axios__WEBPACK_IMPORTED_MODULE_5__["default"].get("https://api.olympiquemnihla.com/projects/find-all");
                ...
                await Promise.all(projects.map(async (project)=>{
                    try {
                        const response = await axios__WEBPACK_IMPORTED_MODULE_5__["default"].get(`https://api.olympiquemnihla.com/project-donation/get-sum-of-donations/${project.id}`);
